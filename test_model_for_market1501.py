...
if __name__ == '__main__':
    ...
    path1 = '/home/ubuntu/workspace/CVPR2015-CNN-for-ReID-master/dataset/market-1501/bounding_box_test/0194_c6s1_059901_04.jpg'
    path2 = '/home/ubuntu/workspace/CVPR2015-CNN-for-ReID-master/dataset/market-1501/bounding_box_test/1148_c4s5_025904_02.jpg'
    pred = single_test(model, path1, path2)
    print("pedestrian diversi " +  str(pred))
    
    dictionary_test = ['01.jpg', '02.jpg'] 
    path_test = '/home/ubuntu/workspace/CVPR2015-CNN-for-ReID-master/dataset/pedestrian-reidentification-model-trainer/test/01_002.jpg'
    path_dict = '/home/ubuntu/workspace/CVPR2015-CNN-for-ReID-master/dataset/pedestrian-reidentification-model-trainer/dictionary/'
    test_set = ['01_001.jpg' , '01_002.jpg',  '01_003.jpg',  '02_001.jpg',  '02_002.jpg',  '02_003.jpg',  '99_001.jpg',  '99_002.jpg',  '99_003.jpg']
    
    for t in test_set:
        path_img_test = '/home/ubuntu/workspace/CVPR2015-CNN-for-ReID-master/dataset/pedestrian-reidentification-model-trainer/test/'+ t
        for d in dictionary_test:
            path_img_dict = '/home/ubuntu/workspace/CVPR2015-CNN-for-ReID-master/dataset/pedestrian-reidentification-model-trainer/dictionary/'+d
    ...
    path1 = '/home/ubuntu/workspace/CVPR2015-CNN-for-ReID-master/dataset/pedestrian-reidentification-model-trainer/dictionary/01.jpg'
    path2 = '/home/ubuntu/workspace/CVPR2015-CNN-for-ReID-master/dataset/pedestrian-reidentification-model-trainer/test/99_001.jpg'
    pred = single_test(model, path1, path2)
    print("pedestrian 01 -> 99_001 : " +  str(pred))
    
    path1 = '/home/ubuntu/workspace/CVPR2015-CNN-for-ReID-master/dataset/pedestrian-reidentification-model-trainer/dictionary/02.jpg'
    path2 = '/home/ubuntu/workspace/CVPR2015-CNN-for-ReID-master/dataset/pedestrian-reidentification-model-trainer/test/99_001.jpg'
    pred = single_test(model, path1, path2)
